...
export interface INodeProxy extends Omit<IPublicNodeService, 'createByType' | 'createByAsset' | 'query' | 'getPathByUuid' | 'setParent' | 'reorder' | 'copyNode' | 'pasteNode' | 'duplicateNode' | 'cutNode'> {
