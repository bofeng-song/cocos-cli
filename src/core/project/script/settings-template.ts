        ...
        'configs': {
            'defaultConfig': {
                ...
                'cache': {
                    ...
                    'animation': { '_value': true },
                    'skeletal-animation': { '_value': true },
                    '3d': { '_value': true },
                    ...
                    'physics-ammo': {
                        '_value': true,
                        '_flags': { 'LOAD_BULLET_MANUALLY': false }
                    },
                    'physics-cannon': { '_value': false },
                    'physics-physx': {
                        '_value': false,
                        '_flags': { 'LOAD_PHYSX_MANUALLY': false }
                    },
                    ...
                    'webview': { '_value': true },
                    'tween': { '_value': true },
                    'websocket': { '_value': true },
                    'websocket-server': { '_value': false },
                    'terrain': { '_value': true },
                    'light-probe': { '_value': true },
                    'tiled-map': { '_value': true },
                    ...
                    'spine-3.8': {
                        '_value': true,
                        '_flags': { 'LOAD_SPINE_MANUALLY': false }
                    },
                    'spine-4.2': {
                        '_value': false,
                        '_flags': { 'LOAD_SPINE_MANUALLY': false }
                    },
                    'dragon-bones': { '_value': true },
                    'marionette': { '_value': true },
                    ...
                    'custom-pipeline': { '_value': true },
                    'legacy-pipeline': { '_value': false },
                    'xr': { '_value': false }
                },
                'flags': {
